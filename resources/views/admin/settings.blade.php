...
<title>Eco-Community Water Monitor - Settings</title>
...
<a href="/admin" aria-label="Go back" class="flex items-center justify-center w-10 h-10 rounded-full bg-white hover:bg-surface-muted text-primary-dark transition-colors shadow-soft group">
<span class="material-symbols-outlined group-hover:-translate-x-1 transition-transform">arrow_back</span>
</a>
<div class="flex items-center gap-2">
<span class="material-symbols-outlined text-primary">water_drop</span>
<span class="font-serif font-bold text-primary-dark">EcoMonitor</span>
</div>
</div>
...
<section class="bg-surface rounded-[2rem] p-6 md:p-8 shadow-soft border border-transparent transition-all hover:shadow-lg relative overflow-hidden">
<div class="flex items-center justify-between mb-6">
<div class="flex items-center gap-3">
<div class="p-2 bg-blue-50 rounded-2xl text-blue-600">
...
<span class="bg-primary/10 text-primary-dark px-3 py-1 rounded-full text-sm font-bold border border-primary/20">6.5 - 8.5 pH</span>
</div>
<div class="pt-6 pb-2">
<div class="relative h-12 w-full flex items-center">
<div class="absolute w-full h-3 rounded-full bg-gradient-to-r from-[#E76F51] via-[#52B788] to-[#E76F51] opacity-20"></div>
<div class="absolute h-3 rounded-full bg-gradient-to-r from-[#E76F51] via-[#52B788] to-[#E76F51] left-0 right-0"></div>
<div class="absolute w-full h-3 rounded-full bg-surface-muted -z-10"></div>
<div class="absolute left-[30%] -ml-4 top-1/2 -translate-y-1/2 group cursor-ew-resize z-20">
<div class="relative">
<div class="w-8 h-8 bg-white rounded-full shadow-lg border-2 border-[#52B788] flex items-center justify-center transition-transform hover:scale-110">
<div class="w-2 h-2 bg-[#52B788] rounded-full"></div>
</div>
...
<div class="absolute top-1/2 -translate-y-1/2 h-3 bg-[#52B788]/20 backdrop-blur-sm left-[30%] right-[30%] pointer-events-none rounded-r-none rounded-l-none z-10 border-x border-[#52B788]/50"></div>
</div>
...
<section class="bg-surface rounded-[2rem] p-6 md:p-8 shadow-soft border border-transparent transition-all hover:shadow-lg">
<div class="flex items-center justify-between mb-6">
<div class="flex items-center gap-3">
<div class="p-2 bg-amber-50 rounded-2xl text-accent-sand">
...
<div class="py-4">
<div class="relative h-2 bg-surface-muted rounded-full">
<div class="absolute h-full bg-accent-sand rounded-full w-[40%]"></div>
<div class="absolute top-1/2 -translate-y-1/2 left-[40%] -ml-3 w-6 h-6 bg-white border-2 border-accent-sand rounded-full shadow hover:scale-110 transition-transform cursor-pointer"></div>
</div>
</div>
...
<div class="p-2 bg-rose-50 rounded-2xl text-accent-terra">
<span class="material-symbols-outlined">notifications_active</span>
</div>
<h3 class="font-bold text-lg text-primary-dark">Alert Preferences</h3>
</div>
<div class="space-y-4">
<label class="flex items-start gap-4 p-4 border border-primary/10 rounded-2xl cursor-pointer hover:border-primary/30 transition-colors bg-background-light/50">
<div class="relative flex items-center">
<input checked="" class="peer sr-only" type="checkbox"/>
<div class="w-11 h-6 bg-surface-muted peer-focus:outline-none peer-focus:ring-2 peer-focus:ring-[#52B788]/20 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-[#52B788]"></div>
</div>
<div class="flex-1">
...
<input class="w-full text-sm bg-white border border-primary/10 rounded-xl px-4 py-2 focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-shadow text-primary-dark" placeholder="Enter email address" type="email" value="admin@rw04-cilandak.id"/>
</div>
</label>
<label class="flex items-start gap-4 p-4 border border-primary/10 rounded-2xl cursor-pointer hover:border-primary/30 transition-colors bg-background-light/50">
<div class="relative flex items-center">
...
<div class="max-w-[600px] mx-auto bg-white/90 backdrop-blur-xl p-3 rounded-full flex items-center justify-between border border-primary/10 shadow-soft">
<button class="px-6 py-3 rounded-full text-primary/60 hover:text-accent-terra hover:bg-rose-50 text-sm font-bold transition-colors flex items-center gap-2">
<span class="material-symbols-outlined text-lg">restart_alt</span>
                Reset Defaults
            </button>
<button class="px-8 py-3 bg-primary hover:bg-[#52B788] text-white rounded-full text-sm font-bold shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95 flex items-center gap-2">
